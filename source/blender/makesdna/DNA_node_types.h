...
enum {
  ...
  NODE_SPECTRUM_MATH_POWER = 4,
  NODE_SPECTRUM_MATH_LOGARITHM = 5,
  NODE_SPECTRUM_MATH_SQRT = 6,
  NODE_SPECTRUM_MATH_INV_SQRT = 7,
  NODE_SPECTRUM_MATH_ABSOLUTE = 8,
  NODE_SPECTRUM_MATH_EXPONENT = 9,

  NODE_SPECTRUM_MATH_MINIMUM = 10,
  NODE_SPECTRUM_MATH_MAXIMUM = 11,
  NODE_SPECTRUM_MATH_LESS_THAN = 12,
  NODE_SPECTRUM_MATH_GREATER_THAN = 13,
  NODE_SPECTRUM_MATH_SIGN = 14,

  NODE_SPECTRUM_MATH_SINE = 15,
  NODE_SPECTRUM_MATH_COSINE = 16,
  NODE_SPECTRUM_MATH_TANGENT = 17,
};
