...
static void def_map_range_spectrum(StructRNA *srna)
{
  PropertyRNA *prop;
...
static void def_spectrum_math(StructRNA *srna)
{
  PropertyRNA *prop;

  prop = RNA_def_property(srna, "operation", PROP_ENUM, PROP_NONE);
  RNA_def_property_enum_sdna(prop, NULL, "custom1");
  RNA_def_property_enum_items(prop, rna_enum_node_spectrum_math_items);
  RNA_def_property_ui_text(prop, "Operation", "");
  RNA_def_property_update(prop, NC_NODE | NA_EDITED, "rna_ShaderNode_socket_update");
...
static void def_spectrum_curve(StructRNA *srna)
{
  PropertyRNA *prop;
...
static void def_sh_gaussian_spectrum(StructRNA *srna)
{
  PropertyRNA *prop;
...
static void def_sh_tex_sky_spectral(StructRNA *srna)
{
  PropertyRNA *prop;
