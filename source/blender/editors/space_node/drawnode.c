...
static void node_buts_curve_spectrum(uiLayout *layout, bContext *UNUSED(C), PointerRNA *ptr)
{
  uiTemplateCurveMapping(layout, ptr, "mapping", 's', false, false, false, false);
}
...
static void node_shader_set_butfunc(bNodeType *ntype)
{
  switch (ntype->type) {
    ...
    case SH_NODE_CURVE_SPECTRUM:
      ntype->draw_buttons = node_buts_curve_spectrum;
      break;
