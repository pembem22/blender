                                ...
                                PointerRNA *cscene)
{
  ...
  cam->set_camera_response_function_curve(bcam->camera_response_function_curve);
  cam->set_wavelength_importance_curve(bcam->wavelength_importance_curve);
  cam->set_use_custom_wavelength_importance(bcam->use_custom_wavelength_importance);
