...
/* Throughput. */
KERNEL_STRUCT_MEMBER(path, SpectralColor, throughput)
/* Ratio of throughput to distinguish diffuse and glossy render passes. */
KERNEL_STRUCT_MEMBER(path, SpectralColor, diffuse_glossy_ratio)
/* Denoising. */
KERNEL_STRUCT_MEMBER(path, SpectralColor, denoising_feature_throughput)
/* Shader sorting. */
...
KERNEL_STRUCT_MEMBER(ray, SpectralColor, wavelengths)
#endif
...
KERNEL_STRUCT_MEMBER(subsurface, SpectralColor, albedo)
KERNEL_STRUCT_MEMBER(subsurface, SpectralColor, radius)
...
/* Throughput. */
KERNEL_STRUCT_MEMBER(shadow_path, SpectralColor, throughput)
/* Ratio of throughput to distinguish diffuse and glossy render passes. */
KERNEL_STRUCT_MEMBER(shadow_path, SpectralColor, diffuse_glossy_ratio)
