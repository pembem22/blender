...
/* Throughput. */
KERNEL_STRUCT_MEMBER(path, SpectralColor, throughput, KERNEL_FEATURE_PATH_TRACING)
/* Ratio of throughput to distinguish diffuse and glossy render passes. */
KERNEL_STRUCT_MEMBER(path, SpectralColor, diffuse_glossy_ratio, KERNEL_FEATURE_LIGHT_PASSES)
/* Denoising. */
KERNEL_STRUCT_MEMBER(path, SpectralColor, denoising_feature_throughput, KERNEL_FEATURE_DENOISING)
/* Shader sorting. */
...
KERNEL_STRUCT_MEMBER(ray, SpectralColor, wavelengths, KERNEL_FEATURE_SPECTRAL_RENDERING)
...
KERNEL_STRUCT_MEMBER(subsurface, SpectralColor, albedo, KERNEL_FEATURE_SUBSURFACE)
KERNEL_STRUCT_MEMBER(subsurface, SpectralColor, radius, KERNEL_FEATURE_SUBSURFACE)
...
/* Throughput. */
KERNEL_STRUCT_MEMBER(shadow_path, SpectralColor, throughput, KERNEL_FEATURE_PATH_TRACING)
/* Throughput for shadow pass. */
KERNEL_STRUCT_MEMBER(shadow_path, SpectralColor, unshadowed_throughput, KERNEL_FEATURE_SHADOW_PASS)
/* Ratio of throughput to distinguish diffuse and glossy render passes. */
KERNEL_STRUCT_MEMBER(shadow_path, SpectralColor, diffuse_glossy_ratio, KERNEL_FEATURE_LIGHT_PASSES)
