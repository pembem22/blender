...
enum SvmNodeFeatureFlag {
  ...
  NODE_FEATURE_ALL = (unsigned int)(~0),
};

#define NODE_FEATURE_MASK_SURFACE \
...
#define NODE_FEATURE_MASK_LIGHT (NODE_FEATURE_EMISSION | NODE_FEATURE_VORONOI_EXTRA)
...
#define NODES_FEATURE(feature) \
  (((node_feature_mask & __NODES_FEATURES__) & (NODE_FEATURE_##feature)) != 0)
