...
typedef enum ShaderNodeType {
  ...
  NODE_WIREFRAME,
  NODE_WAVELENGTH,
  NODE_GAUSSIAN_SPECTRUM,
  NODE_GAUSSIAN_SPECTRUM_NORMALIZED,
  NODE_BLACKBODY,
  NODE_BLACKBODY_SPECTRAL,
  NODE_MAP_RANGE,
...
typedef enum NodeSpectrumMathType {
  ...
  NODE_SPECTRUM_MATH_POWER,
  NODE_SPECTRUM_MATH_LOGARITHM,
  NODE_SPECTRUM_MATH_SQRT,
  NODE_SPECTRUM_MATH_INV_SQRT,
  NODE_SPECTRUM_MATH_ABSOLUTE,
  NODE_SPECTRUM_MATH_EXPONENT,

  NODE_SPECTRUM_MATH_MINIMUM,
  NODE_SPECTRUM_MATH_MAXIMUM,
  NODE_SPECTRUM_MATH_LESS_THAN,
  NODE_SPECTRUM_MATH_GREATER_THAN,
